...
# === adding Mean relatedness lines to the plot === (change lwd of blue line to 2.5 when plotting data of the 1000 individuals, to better visualize it)
lines(x_vals, het_mean_nrnr, col = "#54BFB7FF", lwd = 2.5)
lines(x_vals, het_mean_nrr, col = "#894B33FF", lwd = 2)
lines(x_vals, het_mean_r, col = "tan1", lwd = 2)

mtext("Relatedness and Heterozygosity Over Time \n(1000 individuals)", side = 3, line = -2, outer = TRUE, cex = 1.2, font = 2) #creates a shared title
...
plot(x_vals, rel_med_nrnr, type = "n",
     xlab = "Generation", ylab = "Relatedness",
     ylim = c(min_rel, max_rel)
     #, main = "Relatedness over Generations \n(median & 25/75% - 16 individuals)")
)

#Draw median (solid line) and quartiles (dashed lines)
# Model: non-random non-related
#when running with 1000 individuals, change size of the blue lines, to make them visible behind the orange ones. 
lines(x_vals, rel_med_nrnr, col = "#54BFB7FF", lwd = 3, lty = 1) #lwd is line width, lty is line type
lines(x_vals, rel_p25_nrnr, col = "#54BFB7FF", lwd = 2, lty = 3)
lines(x_vals, rel_p75_nrnr, col = "#54BFB7FF", lwd = 2, lty = 3)
...
# Model: random
lines(x_vals, rel_med_r, col = "tan1", lwd = 2, lty = 1)
...
# Model: non-random non-related
#when running with 1000 individuals, change size of the blue lines, to make them visible behind the orange ones. 
lines(x_vals, het_med_nrnr, col = "#54BFB7FF", lwd = 3, lty = 1) #lwd is line width, lty is line type
lines(x_vals, het_p25_nrnr, col = "#54BFB7FF", lwd = 2, lty = 3)
lines(x_vals, het_p75_nrnr, col = "#54BFB7FF", lwd = 2, lty = 3)
...
#Add a shared main
mtext("Relatedness and Heterozygosity Over Time \n (median & 25/75% - 1000 individuals)", side = 3, line = -2, outer = TRUE, cex = 1.2, font = 2) #creates a shared title
#font.main = 2 makes the main bold
