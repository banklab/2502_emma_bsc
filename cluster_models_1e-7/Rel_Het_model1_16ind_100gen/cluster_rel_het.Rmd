...
#change title to 16/1000 indivuals depending on the data
...
#when 1000 individuals change to lty = c(1, 1, 4)
...
And a last plot where one can see the median and 25/75% quartiles
