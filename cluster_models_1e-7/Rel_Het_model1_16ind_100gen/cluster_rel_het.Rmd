...
# Model: random
lines(x_vals, rel_med_r, col = "tan1", lwd = 2.5, lty = 4) #change lty to 4 when running it with 1000 individuals
...
lines(x_vals, het_med_r, col = "tan1", lwd = 2, lty = 4)
...
legend("bottom", inset = c(0, -0.6), horiz = FALSE, ncol     = 3, 
  legend = c("nrnr median", "nrnr 25/75%", "nrr median", "nrr 25/75%", "r median","r 25/75%"),
       col    = c("#54BFB7FF", "#54BFB7FF",
                  "#894B33FF", "#894B33FF",
                  "tan1",       "tan1"),
       lty    = c(1, 2, 1, 2, 4, 2), #change fifth digit to 4 (not 1) when running with 1000 individuals
