...
This file is for analyzing the outputs of the Mating model, run on the server. I want to check with this code, how many individuals get to mate per generation in the different mate choice scenarios (R and Nrnr)
