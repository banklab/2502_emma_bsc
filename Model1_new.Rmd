...
setwd("~/Documents/GitHub/2502_emma_bsc/Model1_100gen_16-1000ind_20reps")
...
matplot( x_values, results_df_nrnr, type = "p", pch = 16, 
        col = rgb(0.5, 0.7, 1, 0.2), # Model nrnr: light blue points, rgb(red, green, blue, alpha) enables me to modify the colors a bit better, alpha is the transparacy
...
matpoints(x_values, results_df_nrr, pch = 16, col = rgb(0.6, 0.9, 0.6, 0.2)) #adding points to the existing plot from above

# Model r: light purple points
matpoints( x_values, results_df_r, pch = 16, col = rgb(0.8, 0.7, 1, 0.2)) #again

# adding Mean relatedness lines to the plot
lines( x_values, mean_nrnr, col = "cornflowerblue", lwd = 2)
lines( x_values, mean_nrr, col = "mediumseagreen", lwd = 2)
lines( x_values, mean_r, col = "mediumorchid", lwd = 2)

#create a legend for my plot
legend("bottomleft", legend=c("non-random non-related", "non-rendom related", "random"), col=c("cornflowerblue", "mediumseagreen", "mediumorchid"), lty=1, cex = 0.7)
