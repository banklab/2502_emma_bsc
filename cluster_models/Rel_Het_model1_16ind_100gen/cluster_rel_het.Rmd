...
matplot(x_vals, rel_matrix_nrnr, type = "p", pch = 16, cex = 0.4,
        col = adjustcolor("#54BFB7FF", alpha.f = 0.015),
        xlab = "Generation", ylab = "Relatedness",
        ylim = c(min_rel, max_rel))  


# Model nrr: light green points
matpoints(x_vals, rel_matrix_nrr, pch = 16, cex = 0.4, col = adjustcolor("#894B33FF", alpha.f = 0.015)) #adding points to the existing plot from above

# Model r: light purple points
matpoints(x_vals, rel_matrix_r, pch = 16, cex = 0.4, col = adjustcolor("tan1", alpha.f = 0.015)) #again
...
# Model nrnr: light blue points
matplot(x_vals, het_matrix_nrnr, type = "p", pch = 16, cex = 0.4,
        col = adjustcolor("#54BFB7FF", alpha.f = 0.015),
...
# Model nrr: light green points
matpoints(x_vals, het_matrix_nrr, pch = 16, cex = 0.4, col = adjustcolor("#894B33FF", alpha.f = 0.015)) #add points

# Model r: light purple points
matpoints(x_vals, het_matrix_r, pch = 16, cex = 0.4, col = adjustcolor("tan1", alpha.f = 0.015)) #add points
